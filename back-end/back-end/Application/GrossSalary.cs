...
namespace back_end.Application
{
  public class GrossSalary : IGrossSalary
  {
    ...
    public void SetDateRange(string startDateString, string endDateString)
    {
      if (!DateOnly.TryParse(startDateString, out startDate))
      {
        throw new Exception("Start date format is invalid.");
      }

      if (!DateOnly.TryParse(endDateString, out endDate))
      {
