<template>
  ...
  <div v-if="!isLoading && !showPopup" class="container mt-5 mb-5">
    <h1 class="text-center mb-4" style="color: #405d72">Nombre de Empresa</h1>
    <h2 class="text-center mb-4" style="color: #758694">Lista de Empleados</h2>
    <table
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button
            type="button"
            class="btn-close"
            @click="closeEmployeeDetailsModal"
          ></button>
        </div>
        <div class="modal-body">
          <p>
            <strong>Nombre completo:</strong>
            {{ selectedEmployee.completeName || "Nombre no disponible" }}
          </p>
          <p>
            <strong>Cédula:</strong>
            {{ selectedEmployee.identification || "Cédula no disponible" }}
          </p>
          <p>
            <strong>Correo electrónico:</strong>
            {{ selectedEmployee.email || "Correo no disponible" }}
          </p>
          <p>
            <strong>Teléfono:</strong>
            {{ selectedEmployee.phoneNumber || "Teléfono no disponible" }}
          </p>
          <p>
            <strong>Rol:</strong> {{ selectedEmployee.role || "No asignado" }}
          </p>
          <p>
            <strong>Fecha de ingreso:</strong>
            {{ selectedEmployee.hireDate || "Fecha no disponible" }}
          </p>
          <p>
            <strong>Supervisor asignado:</strong>
            {{ selectedEmployee.supervisor || "No asignado" }}
          </p>
          <p>
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <input
                  type="text"
                  class="form-control"
                  v-model="selectedEmployee.canton"
                  id="canton"
                  readonly
                />
              </div>
              <div class="col-md-6">
                ...
                <input
                  type="text"
                  class="form-control"
                  v-model="selectedEmployee.district"
                  id="district"
                  readonly
                />
              </div>
              <div class="col-md-6">
                ...
                <textarea
                  class="form-control"
                  style="height: 38px"
                  v-model="selectedEmployee.otherSigns"
                  id="otherSigns"
                  rows="2"
                  readonly
                ></textarea>
